...
const Suprise = () => {
  return (
            ...
            <div className='text-[rgba(25,14,3,1.00)] '>
                <h2 className='flex py-[2rem] pl-[8rem] '>SUPRISE A FRIEND</h2>
                <p className='flex pl-[8rem]'>Do you want to surprise your friend at work? 
                Then what is better than getting a coffee to their workplace! 
         </p>
         <button className=" bg-[rgba(25,14,3,1.00)] text-white opacity-85 text-[15px] p-3 rounded  mt-8 ml-[8rem]">Let's Go</button>

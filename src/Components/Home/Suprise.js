...
const Suprise = () => {
  return (
    ...
    <div className="md:shrink-0">
            <img className="rounded  w-full p-10 object-cover md:h-full md:w-[24em] md:p-0 md:ml-[5em]" src = {supriseImage} alt="Coffee" />
        </div>
        <div className='text-[rgba(25,14,3,1.00)] p-12 text-left md:text-left justify-content: end'>
